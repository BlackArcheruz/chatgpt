    ...
    <>
      ...
      <div className={styles.topnav}>
        ...
        <div className={styles.navlinks}>
          ...
          <button className="border rounded-md border-gray-300 py-2 px-4 transition ease-in-out hover:bg-gray-300 hover:text-gray-800" onClick={props.user ? null : props.signIn}>{props.user ? props.user : "Sign In"}</button>
        </div>
      </div>
